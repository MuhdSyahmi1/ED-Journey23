<x-layouts.app title="Manage Manager">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="space-y-4 mb-8">
                <div>
                    ...
                    <span class="text-gray-900">sarah.thompson@gmail.com</span>
                </div>
                <div>
                    <span class="font-medium text-gray-700">Role:</span>
                    <span class="text-gray-900">Admission Manager</span>
                </div>
                <div>
            ...
            <div class="flex justify-start space-x-4">
                <button class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-md font-medium transition">
                    Deactivate
                </button>
