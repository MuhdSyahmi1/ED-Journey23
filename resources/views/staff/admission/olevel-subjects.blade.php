<x-layouts.app title="O Level Subjects">
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">O LEVEL SUBJECTS</h1>
                    <p class="text-gray-600 dark:text-gray-400">Manage O Level subject requirements and configurations</p>
                </div>
                <a href="{{ route('staff.admission.programme-management') }}" 
                   class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 text-sm font-medium transition-colors duration-200 flex items-center gap-2" 
                   wire:navigate>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Manage O Level Subjects</h2>
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6">
                <form method="GET" action="{{ route('staff.admission.olevel-subjects') }}" class="flex flex-col md:flex-row gap-4">
                    <!-- Search -->
                    <div class="flex-1">
                    ...
                    <div class="flex gap-2 items-end">
                        ...
                        <a href="{{ route('staff.admission.olevel-subjects') }}" 
                        ...
                        @forelse($subjects as $subject)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-medium rounded-full {{ $subject->qualification === 'GCE' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300' : 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <div class="flex gap-2">
                                        ...
                                        <form method="POST" action="{{ route('staff.admission.olevel-subjects.destroy', $subject->id) }}" 
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    ...
                                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No O Level Subjects</h3>
    ...
    <div id="addSubjectModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <form method="POST" action="{{ route('staff.admission.olevel-subjects.store') }}" class="space-y-4">
                @csrf
                <div>
    ...
    <div id="editSubjectModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <form id="editForm" method="POST" class="space-y-4">
                ...
                <div class="flex gap-3 pt-4">
                    <button type="submit" class="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors duration-200">
                        Update Subject
                    </button>
    ...
    <script>
        function editSubject(id, name, qualification) {
            ...
            document.getElementById('editForm').action = `/staff/admission/olevel-subjects/${id}`;
