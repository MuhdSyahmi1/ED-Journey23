                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select id="duration" 
                                    ...
                                    <option value="3 years" {{ request('duration') == '3 years' ? 'selected' : '' }}>3 Years</option>
                                    <option value="4 years" {{ request('duration') == '4 years' ? 'selected' : '' }}>4 Years</option>
                                    <option value="2 years" {{ request('duration') == '2 years' ? 'selected' : '' }}>2 Years</option>
                                </select>
                            </div>
