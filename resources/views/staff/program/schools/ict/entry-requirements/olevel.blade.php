...
<x-layouts.app>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('staff.program.school', 'ict') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50 dark:from-slate-900 dark:to-purple-950 transition-colors duration-300">
        <div class="p-6">
            <div class="max-w-7xl mx-auto">
                
                <!-- Back Button -->
                <div class="mb-6">
                    <flux:button variant="ghost" size="sm" href="{{ route('staff.program.school', 'ict') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <input type="text" 
                                       ...
                                       class="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                            </div>
                            ...
                            <div class="flex items-end gap-2">
                                ...
                                <a href="{{ route('staff.program.school.programmes.olevel', ['school' => 'ict', 'programmeId' => $programmeId]) }}" class="bg-slate-500 hover:bg-slate-600 text-white px-4 py-2 rounded-lg transition-colors">
                                    Reset
                                </a>
                            </div>
                        </div>
                ...
                <form id="addOLevelForm" onsubmit="submitAddOLevel(event)">
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="oLevelSubjectName" name="subject_name" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-purple-500" onchange="updateQualifications()">
                        ...
                        <div>
                            ...
                            <select id="oLevelQualification" name="qualification" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                        ...
                        <div>
                            ...
                            <select id="oLevelCategory" name="category" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                        ...
                        <div>
                            ...
                            <select id="minGrade" name="min_grade" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                ...
                const row = `
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" name="selected_olevel[]" value="${requirement.id}" class="rounded border-slate-300 text-purple-600 focus:ring-purple-500" onchange="updateBulkActions()">
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex gap-2">
                                <button onclick="editOLevelRequirement(${requirement.id})" class="text-purple-600 hover:text-purple-900 dark:text-purple-400 dark:hover:text-purple-300">
